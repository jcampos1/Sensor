		...
		function($translateProvider) {
			$translateProvider.translations('en', {
				...
				"TLTPS": {
					...
					"TP12":				"Test the connection to the microcontroller with the indicated parameters",
					"TP13":				"Stop port reading process",
					"TP14":				"Update connection parameters and launch reading process",
			...
			$translateProvider.translations("es", {
				...
				"TLTPS": {
					...
					"TP12":				"Probar la conexión al microcontrolador con los parámetros indicados",
					"TP13":				"Detener proceso de lectura del puerto",
					"TP14":				"Actualizar parámetros de conexión y lanzar proceso de lectura",
