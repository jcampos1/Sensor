...
angular.module("GRIDMAE1009", [ 'ui.bootstrap', 'ngTouch', 'ui.grid',
		'ui.grid.pagination', 'ui.grid.selection', 'messages' ]);

/* *********************** SERVICIOS ********************** */

"use strict";
angular.module('GRIDMAE1009').service('MAE1009ConfigurationGrid',
		MAE1009ConfigurationGrid);
MAE1009ConfigurationGrid.$inject = [ '$http', '$log', '$uibModal',
		'uiGridConstants', '$translate' ];
function MAE1009ConfigurationGrid($http, $log, $uibModal,
		uiGridConstants, $translate) {
	/** ********************** VARIABLES PRIVADAS ******************* */
	...
	function getPage($scope) {
		...
		$http.post("/WeighBridgeStandAlone/MAE1009/externPagSimple", obj).then(function(response) {
