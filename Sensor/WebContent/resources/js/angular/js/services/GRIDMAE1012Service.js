...
angular.module("GRIDMAE1012", [ 'ui.bootstrap', 'ngTouch', 'ui.grid',
		'ui.grid.pagination', 'ui.grid.selection', 'messages' ]);

/* *********************** SERVICIOS ********************** */

"use strict";
angular.module('GRIDMAE1012').service('MAE1012ConfigurationGrid',
		MAE1012ConfigurationGrid);
MAE1012ConfigurationGrid.$inject = [ '$http', '$log', '$uibModal',
		'uiGridConstants', '$translate' ];
function MAE1012ConfigurationGrid($http, $log, $uibModal,
		uiGridConstants, $translate) {
	/** ********************** VARIABLES PRIVADAS ******************* */
	...
	function getPage($scope) {
		...
		$http.post("/WeighBridgeStandAlone/MAE1012/externPagSimple", obj).then(function(response) {
