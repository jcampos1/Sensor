<div id="modalgridmae1011" class="modal-content">
	<div class="modal-header">
		<h3 class="box-title">{{ 'GENE.COND' | translate}}</h3>
	</div>
	...
	<div class="modal-footer">
		<a ng-click="cancel()" class="btn btn-app btn btn-warning">
			<i class="fa fa-close"></i> {{ 'GENE.CANCEL' | translate }}
		</a>
	</div>
</div>
