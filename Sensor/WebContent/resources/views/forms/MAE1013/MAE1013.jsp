<div class="modal-header">
	<h3 class="box-title">{{ ('FORM.MAE1013' | translate)+('FORM.NEW'
		| translate) }}</h3>
</div>
<div id="FATH_FORM" class="modal-body">
	<!--  -->
	<form id="MAE1013Form" name="MAE1013Form" novalidate="true">
		<div class="row">
			<div class="col-sm-6">
				<h5>{{ 'MAE1013.TIPM' | translate }}</h5>
				<select name="tipm" chosen="{width: '100%'}" ng-change="changeTipm()"
					...
					ng-show="!MAE1013Form.tipm.$untouched && MAE1013Form.tipm.$error.required"
		...
		<div class="row">
			<div class="col-sm-6">
				...
				<select ng-change="selectOrigin()" name="origin"
					...
					ng-show="!MAE1013Form.origin.$untouched && MAE1013Form.origin.$error.required"
					class="logError has-error"><label class="control-label"
			...
			<div class="col-sm-6" ng-if="mae1013.origin.id==0">
				<search-mae1017-component nameform="MAE1013Form"
					mae1017="mae1013.orig_p" formm="MAE1013Form" />
			</div>
			<!-- Almacén origen -->
			<div class="col-sm-6" ng-if="mae1013.origin.id==1">
			<search-mae1018-component nameform="MAE1013Form"
					mae1018="mae1013.orig_a" formm="MAE1013Form" />
			</div>
		</div>
		<div class="row">
			<div class="col-sm-6">
				...
				<select ng-change="selectDestin()" name="destiny"
					...
					ng-show="!MAE1013Form.destiny.$untouched && MAE1013Form.destiny.$error.required"
					class="logError has-error"><label class="control-label"
			...
			<div class="col-sm-6" ng-if="mae1013.destin.id==0">
				<search-mae1017-d-component nameform="MAE1013Form"
					mae1017="mae1013.dest_p" formm="MAE1013Form" />
			</div>
			<!-- Almacen destino -->
			<div class="col-sm-6" ng-if="mae1013.destin.id==1">
			
			<search-mae1018-d-component nameform="MAE1013Form"
					mae1018="mae1013.dest_a" formm="MAE1013Form" />
			</div>
		</div>
		<div class="row">
			<div class="col-sm-6">
			...
			<div class="col-sm-6">
				<search-mae1012-component nameform="MAE1013Form"
					mae1012="mae1013.motr" formm="MAE1013Form" />
			</div>
		</div>
		<div class="row">
			<div class="col-sm-6">
				<search-mae1011-component nameform="MAE1013Form"
					mae1011="mae1013.cond" formm="MAE1013Form" />
			</div>
			<div class="col-sm-6">
				<search-mae1016-component nameform="MAE1013Form"
					mae1016="mae1013.company" formm="MAE1013Form" />
			</div>
		</div>
		<br />
		<div class="modal-footer">
			...
			</a> <a ng-disabled="!MAE1013Form.$valid" ng-click="submitForm(mae1013, MAE1013Form)"
