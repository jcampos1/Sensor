<div id="mstr_role" style="position: relative;">
	<div ng-controller="RoleCtrl">
		...
		<!-- Vista detalle -->
		<%@ include file="/resources/views/forms/role/detail.jsp"%>

		<!-- Vista para actualizacion -->
		<%@ include file="/resources/views/forms/role/edit.jsp"%>
		...
		<div class="row">
			<div class="col-lg-12" style="text-align: center;">
				<h3>
					<i class="fa fa-home"></i>&nbsp;<strong>{{"GENE.ROLES" |
						translate}}</strong>
				</h3>
			</div>
		</div>
